...
import { LANDING_USE_CASES, landingIntent } from './landingIntent';
...
export default function HomePage() {
  return <div className="home-page landing-v2">
    ...
    <section className="landing-section landing-difference" aria-labelledby="difference-title"><div className="shell landing-split"><div className="landing-section-intro"><p className="eyebrow">Больше, чем готовый разбор</p><h2 id="difference-title">Одна карта — множество вопросов</h2><p>Обычный разбор заканчивается текстом. В Lunaria после ответа можно уточнить непонятное, углубиться в тему или перейти к следующему вопросу.</p><p>Создайте карту один раз — Lunaria будет учитывать её в следующих разговорах.</p></div><div className="landing-flow" aria-label="Путь разговора"><span>Натальная карта</span><i>→</i><span>Ваш вопрос</span><i>→</i><span>Ответ</span><i>→</i><span>Продолжение</span></div></div></section>
